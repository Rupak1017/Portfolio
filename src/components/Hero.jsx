...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen mx-auto scroll-mt-20">
      {/* Text content - must load early */}
      <div
        className={`absolute inset-0 top-[115px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5 z-10`}
      >
      ...
      <div className="absolute inset-0 z-0">
        <ComputersCanvas onLoaded={() => setCanvasReady(true)} />
      </div>
